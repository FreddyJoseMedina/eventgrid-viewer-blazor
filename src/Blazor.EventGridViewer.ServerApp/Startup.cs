...
using Microsoft.AspNetCore.Authentication.OpenIdConnect; // Asegúrate de tener este 'using'
using Microsoft.Identity.Web; // Asegúrate de tener este 'using'

// Si usas la UI de autenticación
